...
<<<<<<< HEAD
  ...
  return (
    <>
      <li>
        <Link href={`/dashboard?nipnuptk=${nipnuptk}`} className="group flex items-center rounded-lg p-2 text-white hover:bg-gray-700">
=======
  const { npsn } = router.query;
  return (
    <>
      <li>
        <Link href={`/dashboard?npsn=${npsn}`} className="group flex items-center rounded-lg p-2 text-white hover:bg-gray-700">
